...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`accounts` (
  ...
  `enabled` BIT NULL COMMENT 'Status (Enable/Disable)' ,
  `note` TEXT NULL ,
  ...
  `allow_review` BIT NULL DEFAULT 1 COMMENT 'is account allow user to comment? switch' ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`users` (
  ...
  `created` DATETIME NULL ,
  `modified` DATETIME NULL ,
  `is_active` BIT NULL COMMENT 'is user active or not' ,
  `is_delete` BIT NULL COMMENT 'deleted user' ,
...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`menus` (
  ...
  `created` DATETIME NULL ,
  `modified` DATETIME NULL ,
  `is_published` BIT NULL COMMENT 'Menu was created' ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`registration` (
  ...
  `is_send` BIT NULL COMMENT 'is registration email was sent?' ,
  `created` DATETIME NULL ,
  `modified` DATETIME NULL ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`accounts_users` (
  ...
  `user_id` INT NOT NULL ,
  `account_id` INT NOT NULL ,
  `deleted` BIT NULL COMMENT 'is the user removed from the relationship' ,
...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`accounts_images` (
  ...
  `created` DATETIME NULL ,
  `modified` DATETIME NULL ,
  `primary` BIT NULL COMMENT 'primary image display as account portrait' ,
  PRIMARY KEY (`id`) ,
...
CREATE  TABLE IF NOT EXISTS `kaigenie`.`menuitem_images` (
  ...
  `created` DATETIME NULL ,
  `modified` DATETIME NULL ,
  `is_primary` BIT NULL COMMENT 'show in menu item' ,
  PRIMARY KEY (`id`) ,
